...
// 3. Raw Zimbabwean Public Holidays Data (2026)
const RAW_HOLIDAYS = [
...
app.get('/api/schedule', async (req, res) => {
    try {
        ...
        // Filter out malformed database entries missing critical properties
        const bookings = rawBookings.filter(b => b && b.practitioner && b.slot && b.date);
        const dbBlocks = rawBlocks.filter(b => b && b.practitioner && b.slot && b.date);
